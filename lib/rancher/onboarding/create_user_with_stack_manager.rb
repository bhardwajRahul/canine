class Rancher::Onboarding::CreateUserWithStackManager
  ...
  executed do |context|
    ActiveRecord::Base.transaction do
      ...
      rancher_access_token = context.personal_access_token.presence || context.access_token
      provider = context.user.providers.find_or_initialize_by(provider: Provider::RANCHER_PROVIDER)
      provider.access_token = rancher_access_token
      provider.save!

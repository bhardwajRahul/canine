...
RSpec.describe Resources::Projects::Show do
  ...
  it "returns full project details including services and volumes" do
    ...
    result = described_class.call(uri: "canine://projects/#{project.id}", user: user, account_user: account_user)
  ...
  it "returns not_found for inaccessible project" do
    ...
    result = described_class.call(uri: "canine://projects/#{other_project.id}", user: user, account_user: account_user)
